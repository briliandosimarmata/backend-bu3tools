...
public class MenuStructureUtils {
	...
	private static final String MENU_INFO_INTERFACE_TS = "interface MenuInfo {\n" + "  menuId: string;\n"
			+ "  menuSequence: string;\n" + "  icon?: string;\n" + "  url?: string;\n" + "}";

	private static final String MENU_MASTER_TS = "export const MENU_INFO_MASTER: MenuInfo = {\n" + "  menuId: '0000',\n"
			+ "  menuSequence: '01',\n" + "  icon: 'fa fa-cogs',\n" + "};";
	...
	private static <T extends MenuStructureDto> String generateMenuInfoScript(List<T> menuStructureDtos) {

		StringBuilder sbScript = new StringBuilder();
		sbScript.append(MENU_MASTER_TS);
		sbScript.append("\n\n");
		sbScript.append("export const MENU_INFO_LIST: MenuInfo[] = [\n" + "  MENU_INFO_MASTER,");
	...
	public static <T extends MenuStructureDto> byte[] generateMenuInfoTypescript(List<T> menuStructureDtos)
			throws Exception {
		String script;
		byte[] file;
